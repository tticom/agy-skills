...
- **[git-guardrails-gemini-code](./git-guardrails-gemini-code/SKILL.md)**: Set up Gemini Antigravity hooks to block dangerous git commands (push, reset --hard, clean, etc.) before they execute.
